...
def get_standings():
    filename = r'C:\Users\berar\Documents\Projects\visualization_demo\mlb_2023_al_west_race\mlb_standings.csv'
    df = pd.read_csv(filename)
    df['Division'] = df['League'] + ' ' + df['Division']
    return df

def get_data_results():
    filename = r'C:\Users\berar\Documents\Projects\visualization_demo\mlb_2023_al_west_race\schedule_results.csv'
    df = pd.read_csv(filename)
...
def get_attendance():
    filename = r'C:\Users\berar\Documents\Projects\visualization_demo\mlb_att.csv'
    df = pd.read_csv(filename)
    return df

def get_population():
    filename = r'C:\Users\berar\Documents\Projects\visualization_demo\tm_pop.csv'
    df = pd.read_csv(filename)
    df = df[df['Radius']==25]
    return df
